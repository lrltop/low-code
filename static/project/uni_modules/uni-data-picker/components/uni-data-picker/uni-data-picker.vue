<template>
	<view class="uni-data-tree">
		<view class="uni-data-tree-input" @click="handleInput">
			<slot :options="options" :data="inputSelected" :error="errorMessage">
				<view class="input-value" :class="{'input-value-border': border}">
                    ...
                    <u-icon v-if="(!clearIcon || !inputSelected.length) && !readonly " name="arrow-right" color="#999" size="18"></u-icon>
				</view>
			</slot>
		</view>
		...
		<view v-if="isOpened" class="uni-data-tree-dialog">
			...
			<data-picker-view ref="pickerView" v-model="dataValue" class="picker-view" :localdata="localdata"
