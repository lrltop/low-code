...
// mock数据
import Mock from '@/libs/function/mock-min.js'
// md5加密
 ...
 * ue.fn.timeFormat(new Date(),"yyyy-MM-dd hh:mm:ss");
 */
 ...
 * ue.fn.getDayOffsetStartAndEnd(0);
 */
 ...
 * @param {Date || Number} date 指定从那天开始计算
 * ue.fn.getMonthOffsetStartAndEnd(0);
 */
 ...
 * @param {Date || Number} date 指定从那天开始计算
 * ue.fn.getYearOffsetStartAndEnd(0);
 */
...
rules: {
  receiver_mobile:[
    { validator:ue.fn.validator("mobile"), message: '手机号格式错误', trigger: 'blur' }
  ],
},
 */
 ...
 * @param {Object} 	obj
 * let newObj = ue.fn.copyObject(obj);
 */
 ...
 * @param {Object} 	obj
 * let newObj = ue.fn.deepClone(obj);
 */
 ...
 * that.form1 = ue.fn.formAssign(defaultData,itemData);
 */
 ...
 * let arr = ue.fn.arr_concat(arr1, arr2, "_id");
 */
...
pubfn.getObject = function(obj,name) {
	try{
		return obj[name];
	}catch(e){
		throw Error(name+'::格式错误,仅支持catalog.module')
	}
}
 ...
 * ue.fn.setData(dataObj, name, value);
 */
...
/**
 * 检测参数是否不为空 结果与 ue.fn.isNull 相反
 * ue.fn.isNotNull(value);
 */
...
/**
 * 检测所有参数 - 是否至少有一个为空
 * ue.fn.isNullOne(value1,value2,value3);
 */
 ...
 * 检测整个对象是否没有一个属性是空值,如果有空值,则返回首个是空值的属性名
 let nullKey = ue.fn.isNullOneByObject({ value1,value2,value3 });
...
/**
 * 检测所有参数 - 是否全部为空
 * ue.fn.isNullAll(value1,value2,value3);
 */
...
/**
 * 检测所有参数 - 是否全部都不为空
 * ue.fn.isNotNullAll(value1,value2,value3);
 */
 ...
 * ue.fn.getListItem(list, key, value);
 */
 ...
 * ue.fn.getListIndex(list, key, value);
 */
 ...
 * @param	{String} key 键名
 * @param	{String} value 键值
 * ue.fn.getListItemIndex(list, key, value);
 */
 ...
 * 提取_id字段转成
 * ["001","002"]
 * let idArr = ue.fn.arrayObjectGetArray(list, "_id");
 */
 ...
 * ue.fn.random(6);
 * ue.fn.random(6, "abcdefghijklmnopqrstuvwxyz0123456789");
 * ue.fn.random(1,"12",["1","2"]);
 */
 ...
 * ue.fn.stringIdToNumberId(uid,8);
 */
 ...
 * ue.fn.checkArrayIntersection(arr1, arr2);
 */
 ...
 * ue.fn.checkDataExpText(data, expText);
 */
 ...
 * ue.fn.deleteObjectKeys(data, deleteKeys);
 */
 ...
 * ue.fn.arrayToTree(treeData, treeProps);
 */
 ...
 * ue.fn.treeToArray(treeData, treeProps);
 */
 ...
 * ue.fn.wildcardTestOne(text, expText);
 */
 ...
 * ue.fn.wildcardTest(text, expText);
 */
 ...
 * ue.fn.regExpTestOne(text, expText);
 */
 ...
 * ue.fn.string2Number(obj, option);
 */
 ...
 * precision	数值精度
 * ue.fn.calcSize(length,["B","KB","MB","GB"],1024,3);
 */
...
/**
 * 获取平台信息
 * let platform = ue.fn.getPlatform();
 */
...
ue.fn.fileToBase64({ file }).then(base64 => {
...
ue.fn.base64ToFile({ base64 }).then(file => {
